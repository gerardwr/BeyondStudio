...
/* NPDU Pool */
PRIVATE pdum_tsNPdu s_asNPduPool[13];
...
PUBLIC pdum_tsAPduInstance s_asapduZDPInstances[8] = {
...
PUBLIC pdum_tsAPduInstance s_asapduZCLInstances[8] = {
...
#endif
    pdum_vNPduInit(s_asNPduPool, 13, mutexMAC);
